  ...
  | Omit<
      IChatConversation<
        'codex-app-server',
        {
          ...
          codex_thread_role?: 'root' | 'subagent';
          codex_parent_thread_id?: string;
          codex_parent_conversation_id?: string;
          codex_subagent_kind?: string;
          codex_agent_path?: string;
          codex_agent_nickname?: string;
          codex_agent_role?: string;
          codex_agent_depth?: number;
          codex_can_accept_direct_input?: boolean;
          codex_subagent_total_count?: number;
          codex_subagent_running_count?: number;
          codex_subagent_completed_count?: number;
          codex_auto_title?: boolean;
          codex_last_message_preview?: string;
          cron_job_id?: string;
          preset_assistant_id?: string;
          pinned?: boolean;
          pinned_at?: number;
